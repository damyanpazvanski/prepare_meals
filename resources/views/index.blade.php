            ...
            <nav class="navbar navbar-expand-lg navbar-light bg-light">
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    <ul class="navbar-nav mr-auto">
                        ...
                        <li class="nav-item"><a  href="static.blade.php">Blog</a></li>
        ...
        <div id="app">
            ...
            <section class="main_slider_area">
                <div id="main_slider" class="rev_slider" data-version="5.3.1.6">
                    <ul>
                        ...
                        <!-- MAIN IMAGE -->
                            <img src="/images/home-slider/slider-1.jpg"  alt=""  data-bgposition="center center" data-bgfit="cover"
                            ...
                            <div class="slider_text_box">
                                ...
                                style="z-index: 8;font-family: 'Poppins', sans-serif;font-weight:600;color:#fff;text-transform: uppercase;"><img src="/images/play-video.png" alt=""> <span style="text-decoration: underline;padding-left: 10px;">Watch The Overview</span></div>
                        ...
                        <!-- MAIN IMAGE -->
                            <img src="/images/home-slider/slider-1.jpg"  alt=""  data-bgposition="center center" data-bgfit="cover" data-bgrepeat="no-repeat" class="rev-slidebg" data-no-retina>
                            <!-- LAYER NR. 1 -->
                            <div class="slider_text_box">
                                <div class="tp-caption tp-resizeme secand_text"
                                    data-x="['center','center','center','center','center','center']"
            ...
            <section class="industries_area">
                <div class="left_indus">
                    <div class="indus_img">
                        <img src="/images/indus-laptop.png" alt="">
                    </div>
                </div>
            ...
            <section class="testimonials_area p_100">
                <div class="container">
                    <div class="testimonials_slider owl-carousel">
                        <div class="item">
                            <div class="media">
                                <img class="d-flex rounded-circle" src="/images/testimonials-1.png" alt="">
                                <div class="media-body">
                                    <img src="/images/dotted-icon.png" alt="">
                        ...
                        <div class="row">
                            <div class="col-lg-4 col-md-6">
                                <div class="l_news_item">
                                    <div class="l_news_img"><a href="#"><img class="img-fluid" src="/images/blog/l-news/l-news-1.jpg" alt=""></a></div>
                            ...
                            <div class="col-lg-4 col-md-6">
                                <div class="l_news_item">
                                    <div class="l_news_img"><a href="#"><img class="img-fluid" src="/images/blog/l-news/l-news-2.jpg" alt=""></a></div>
                                    <div class="l_news_content">
                            ...
                            <div class="col-lg-4 col-md-6">
                                <div class="l_news_item">
                                    <div class="l_news_img"><a href="#"><img class="img-fluid" src="/images/blog/l-news/l-news-3.jpg" alt=""></a></div>
                                    <div class="l_news_content">
